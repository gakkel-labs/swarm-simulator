...
class WorldTest {
    ...
    void agentCount_reflectsAdditionsAndRemovals() {
        ...
        var a2 = Agent.create(AgentType.CARRIER, Vector3D.ZERO);
        world.addAgent(a1);
        world.addAgent(a2);
    ...
    void neighbors_returnsAgentsWithinRadius_excludesSelf() {
        ...
        var near = Agent.create(AgentType.EXPLORER, new Vector3D(55, 50, 25));   // distance = 5
        var far = Agent.create(AgentType.EXPLORER, new Vector3D(90, 50, 25));   // distance = 40
    ...
    void neighbors_radiusZero_returnsEmptyList() {
        ...
        var result = world.neighbors(agent, 0.0);
    ...
    @Test
    void constructor_negativeDimension_throwsIllegalArgumentException() {
